...
const testDrawerIcon = ({ tintColor }) => getDrawerIcon('bars', tintColor);

const homeNavOptions = getDrawerNavigationOptions('Home', Colors.primary, 'white', homeDrawerIcon);
const userNavOptions = getDrawerNavigationOptions('User', Colors.primary, 'white', userDrawerIcon);
...
Drawer.navigationOptions = ({ navigation }) => getNavigationOptionsWithAction('Menu', Colors.primary, 'white', getDrawerItem(navigation));
